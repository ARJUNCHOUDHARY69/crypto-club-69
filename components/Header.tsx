      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <a href="https://www.binance.com/en-IN/square/profile/cryptoclub69" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-crypto-gold transition-colors hover:scale-110 hover:shadow-lg hover:shadow-crypto-gold/20 rounded-lg" title="Binance Square">
              <img
            ...
            <a href="https://www.linkedin.com/in/arjunchoudhary69/" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-crypto-gold transition-colors hover:scale-110 hover:shadow-lg hover:shadow-crypto-gold/20 rounded-lg" title="LinkedIn">
              <Linkedin className="w-4 h-4" />
            </a>
            <a href="https://github.com/ARJUNCHOUDHARY69" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-crypto-gold transition-colors hover:scale-110 hover:shadow-lg hover:shadow-crypto-gold/20 rounded-lg" title="GitHub">
              <Github className="w-4 h-4" />
            </a>
            <a href="https://t.me/CRYPTOCLUB69BINANCE" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-crypto-gold transition-colors hover:scale-110 hover:shadow-lg hover:shadow-crypto-gold/20 rounded-lg" title="Telegram">
            ...
            <a href="https://x.com/choudhary00070" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-400 hover:text-crypto-gold transition-colors hover:scale-110 hover:shadow-lg hover:shadow-crypto-gold/20 rounded-lg" title="X (Twitter)">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2 bg-gray-800/50 rounded-lg px-3 py-2 border border-gray-700/50">
              ...
              <div className="text-right">
                <div className="text-xs text-gray-400 font-mono tracking-wider">UTC</div>
